...
curl -l https://github.com/godotengine/godot/releases/download/$1/Godot_v$1_linux.x86_64.zip > godot.zip
curl -l https://github.com/godotengine/godot/releases/download/$1/Godot_v$1_export_templates.tpz > templates.tpz
